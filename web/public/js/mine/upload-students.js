        ...
        if (role == "Admin") {
          ...
          uploadCSV.addEventListener('click', e => {
            ...
            if (selectSection != null) {
              ...
              $('#alert-boxes').append('<div class="alert alert-danger alert-dismissable"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Error!</strong> Please select a section. </div>').fadeIn('slow').delay(5000).queue(function(next) {
                $('.alert.alert-dismissable').fadeOut('slow').remove();
              });
            }
          });
