...
btnReset.addEventListener('click', e  => {
  ...
  // Sign In
  const promise = auth.sendPasswordResetEmail(email).then(function() {
    $( "#alert-boxes" ).append( "<div class='alert alert-success alert-dismissable'>We have successfully sent you an email!</div>");
